                ...
                <div className="feed22">
                    <form>
                      ...
                      <div className="feed30">
                          ...
                          {sweet101.map(sde =>( <div className="feed29"  onClick={()=>{setSpeed4(sde.nase); document.getElementById('farm').style.display='none';setImage(sde.imgs)}}><img src={sde.imgs} alt="" className="feed28"/><span style={{marginLeft:'8px',fontWeight:'600'}}>{sde.nase}</span></div>))}
