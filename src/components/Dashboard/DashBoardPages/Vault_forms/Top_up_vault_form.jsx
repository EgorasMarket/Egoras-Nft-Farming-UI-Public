              ...
              <div className="open_vault_area2ss">
                ...
                <div className="open_vault_area2b">
                  <div className="open_vault_input_titles">
                    <span className="vault_input0">Top up {asset}</span>
                ...
                <button className="open_vault_input_btn">Top Up</button>
              </div>
            </div>
          </div>
        </div>
...
export default Top_up_vault_form;
